          ...
          1
           }, 72f, index =>
           {
            ...
            if (this.m_okButton.IsClicked)
            {
                ...
                API_WE.Sphere(s,radius,id1,Point,m_subsystemTerrain);
               // player.ComponentGui.DisplaySmallMessage(Convert.ToString(id1), false, false);
                // API_WE.Round(s, radius + 1, lenght + 1, (Position)pos1, id1, Point);
